...
reference projects are used or consulted by the current source.
...
| OASIS MQTT 5.0 | OASIS Standard 2019 | OASIS specification notices | MQTT 5 protocol behavior; <https://docs.oasis-open.org/mqtt/mqtt/v5.0/os/mqtt-v5.0-os.html> |
