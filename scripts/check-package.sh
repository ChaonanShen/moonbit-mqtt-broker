...
readonly STAGED_PACKAGE="${source_stage}/_build/publish/ChaonanShen-moonbit-mqtt-broker-0.3.0.zip"
...
readonly PACKAGE="${REPO_ROOT}/_build/publish/ChaonanShen-moonbit-mqtt-broker-0.3.0.zip"
